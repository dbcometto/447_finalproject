...
class fskRecv(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FSK Receiver", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "fskRecv")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'C:\\Users\\C25Dante.Cometto\\447_finalproject\\codeword.dat', False, 0, 0)
...
def main(top_block_cls=fskRecv, options=None):
